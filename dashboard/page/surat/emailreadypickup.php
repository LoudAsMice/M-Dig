...
require '../assets/vendor/PHPMailer/src/SMTP.php';
    $header = "Hore, Surat kamu sudah jadi dan siap diambil";
    $body = '<!DOCTYPE html>
    ...
    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;background:#ffffff;">
        ...
        <td align="center" style="padding:0;">
            ...
            <tr>
                ...
                <img src="https://i.ibb.co/R9ykVKM/h1.png" alt="" width="300" style="height:auto;display:block;" />
                </td>
            </tr>
            <tr>
                ...
                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                    ...
                    <td style="padding:0 0 36px 0;color:#153643;">
                        ...
                        <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Hore surat kamu sudah selesai diproses dan siap diambil, sekarang kamu bisa ambil surat mu di kelurahan dengan menunjukan email ini ya</p>
                        <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><p>Silahkan datangi kantor kelurahan sesuai dengan jam kerja ya</p></p>
                    </td>
                    </tr>
                    <tr>
                    <td style="padding:0;">
