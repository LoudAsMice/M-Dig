...
require '../assets/vendor/PHPMailer/src/SMTP.php';
    $header = "Permohonan pembuatan surat sedang diproses";
    $body = '<!DOCTYPE html>
    ...
    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;background:#ffffff;">
        ...
        <td align="center" style="padding:0;">
            ...
            <tr>
                ...
                <img src="https://i.ibb.co/Z6gYL9R/h1.png" alt="" width="300" style="height:auto;display:block;" />
                </td>
            </tr>
            <tr>
                ...
                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                    ...
                    <td style="padding:0 0 36px 0;color:#153643;">
                        ...
                        <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Saat ini permintaan pembuatan surat kamu sudah sedang kami proses. Silahkan tunggu info selanjutnya ya</p>
                    ...
                    <td style="padding:0;">
                        ...
                        <tr>
                            ...
                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Saat ini surat kamu sedang diproses oleh aparatur desa.</p>
